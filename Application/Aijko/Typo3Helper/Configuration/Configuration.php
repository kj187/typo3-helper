<?php
namespace Aijko\Typo3Helper\Configuration;
...
class Configuration {
	...
	public function initialize() {
		$this->configuration = self::parse(ROOT . 'Data/Configuration/Configuration.ini', TRUE);
		return $this;
	}
	...
	/**
	 * Quelle: http://codeaid.net/php/parse-ini-file-into-a-multi-dimensional-array
